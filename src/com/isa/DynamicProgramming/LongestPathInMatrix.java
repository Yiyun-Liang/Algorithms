...
public class LongestPathInMatrix {
    ...
    public int longestIncreasingPathOne(int[][] matrix) {
    ...
    // idea: find longest path in a directed graph by removing nodes that have out degree of zero,
    // the number of iterations is the length of the path
